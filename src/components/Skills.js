            ...
            <Slider {...settings}>
              <div className="resume-info-details-section">
                ...
                <span className="resume-info-details-value">
                  ReactJs, NextJs, Typescript, HTML, CSS, SCSS, Javascript,
                  jQuery, AJAX
                </span>
              </div>
              <div className="resume-info-details-section">
                ...
                <span className="resume-info-details-value">
                  NodeJs, Express.js, PHP, PHP Symfony, Java, Python
                </span>
              </div>
              <div className="resume-info-details-section">
              ...
              <div className="resume-info-details-section">
                <span className="resume-info-details-title">Servers</span>
                <span className="resume-info-details-value">
                  AWS (ECS, EC2, ECR, Fargate, Amplify, S3, TimeStream,
              ...
              <div className="resume-info-details-section">
                ...
                <span className="resume-info-details-value">
                  Figma, WordPress, Wix, Windows, Linux, MacOs, Office,
                  LibreOffice
                </span>
              </div>
            </Slider>
