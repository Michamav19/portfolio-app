        ...
        <div className="resume-right-container">
          ...
          <div className="resume-info-details">
            <Slider {...settings}>
              ...
              <div className="resume-info-details-section">
                <span className="resume-info-details-title">Udemy Course</span>
                <span className="resume-info-details-value">
                  2023 & 2024: Next.js 14 & React - The Complete Guide
                </span>
                <span className="resume-info-details-secondary-value">
                  Learn NextJs 14 from the ground up and build fullastack
                  ReactJs + NextJs apps with the App Router or Pages Router
                </span>
              </div>
              ...
              <div className="resume-info-details-section">
                <span className="resume-info-details-title">Udemy Course</span>
                <span className="resume-info-details-value">
                  2023 & 2024: Mastering Typescript - 2024 Edition
                </span>
                <span className="resume-info-details-secondary-value">
                  Detailed Course for Typescript
                </span>
              </div>
